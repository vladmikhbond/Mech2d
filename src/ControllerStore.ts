...
import { Space, Mode} from "./Space.js";
...
export class ControllerStore 
{
    ...
    constructor(box: Space, controller: Controller) {
        this.box = box;
    ...
    static sceneToJson(box: Space): string 
    {
    ...
    static restoreSceneFromJson(json: string, box: Space): void 
    {
